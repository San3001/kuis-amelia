...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <img src="logo_mila.jpg" alt="logo" width="60px">
          ...
          <div class="tab-pane fade active show" id="features-tab-1">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="{{asset('iLanding')}}/{{asset('iLanding')}}/assets/img/features-illustration-1.webp" alt="" class="img-fluid">
              </div>
            </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="phone-mockup text-center">
              <img src="{{asset('iLanding')}}/assets/img/phone-app-screen.webp" alt="Phone Mockup" class="img-fluid">
            </div>
