  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="logo_mila.jpg" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="logo_mila.jpg" alt="logo"/></a>
      </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <ul class="icon-data-list">
                    ...
                    <li>
                      <div class="d-flex">
                      <img src="{{asset('skydash')}}/images/faces/face3.jpg" alt="user">
                     <div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="table-responsive">
                        <table id="tblexample" class="display expandable-table" style="width:100%">
                          <thead>
                            <tr>
                              <th>Quote#</th>
                              <th>Product</th>
